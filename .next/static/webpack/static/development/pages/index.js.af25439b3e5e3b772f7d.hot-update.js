...
var Index = function Index(posts) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, console.log("below is in the html"), console.log(allPosts), allPosts.length !== 0 ? allPosts.splice(0, 3).map(function (post) {
    ...
    __self: this
  }, "allPosts.splice(0, 3).map(post =>", __jsx(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    key: post.uid,
    href: "/blog/".concat(post.uid),
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.af25439b3e5e3b772f7d.hot-update.js.map